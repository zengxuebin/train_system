...
<div class="content">
    ...
    <div class="search_box">
        <form action="searchRound" method="post">
            <div class="row g-3 align-items-center">
                <span class="col-auto">往返查询</span>
                <!-- 出发地 -->
                <div class="col-auto">
                ...
                <!-- 返回日期 -->
                <div class="col-auto">
                    <label for="backDate" class="col-form-label">返程日期</label>
                </div>
                <div class="col-auto">
                    <input type="date" id="backDate" name="backDate" class="form-control"
                           value="<fmt:formatDate value="${backDate}" pattern="yyyy-MM-dd"/>">
    ...
    <div class="search_result">
        ...
        <p>
            返：
            <strong>${toStation}-->${fromStation}（
                    <fmt:formatDate value="${backDate}" pattern="MM月dd日"/>&nbsp;&nbsp;
                    ${backWeek}）</strong>
            共计
            <strong>${trainCountByBack}</strong>
            个车次
        </p>
        </c:if>
    </div>
    ...
    <div class="t_list">
        <table class="table table-sm table-bordered table-hover table-striped" style="border-color: #b0cedd;table-layout: fixed;">
            ...
            <tr style="text-align: center;">
                <td colspan="13" class="no-br">
                <span style="
                font-size: 20px;
                color: #fb7403;
                font-weight: 700;">去程</span><br>
                    <span style="color:#fb7403;font-size: 18px;">${fromStation}->${toStation}</span>
                </td>
            </tr>
            </c:if>
            <c:forEach items="${goTrainList}" var="train">
                <tr style="text-align: center;">
            ...
            <tr style="text-align: center;">
                ...
                font-size: 20px;
                color: #fb7403;
                font-weight: 700;">返程</span><br>
                    <span style="color:#fb7403;font-size: 18px;">${toStation}->${fromStation}</span>
                </td>
            </tr>
            </c:if>
            <c:forEach items="${backTrainList}" var="train">
                <tr style="text-align: center;">
                    <th scope="row">${train.trainId}</th>
                    <td style="text-align: left">
                        <strong>
